-- ========================================
-- FERIA VIRTUAL - CREACIÓN DE TABLAS (CORREGIDO)
-- ========================================
...
CREATE TABLE IF NOT EXISTS feria_sectores (
    ...
    categoria_default_id TEXT, -- Texto para categoría (temporal, sin relación)
...
-- NOTA: categoria_default_id es TEXT temporal, puede convertirse a UUID cuando exista tabla categories
