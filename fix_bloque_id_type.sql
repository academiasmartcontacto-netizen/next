-- ==========================================
-- CORREGIR TIPO DE DATO EN feria_puestos.bloque_id
-- ==========================================
...
-- 4. Migrar los datos (si hay datos)
UPDATE feria_puestos 
SET bloque_id = fb.id::text::uuid 
FROM feria_bloques fb 
WHERE feria_puestos.bloque_id_old = fb.id::text;
...
-- 8. Verificación
SELECT 
    'Estructura corregida' as mensaje,
