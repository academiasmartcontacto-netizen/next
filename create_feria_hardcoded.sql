-- ========================================
-- FERIA VIRTUAL - SOLAMENTE TABLAS NECESARIAS
-- ========================================
-- Sin tabla categories - categorías hardcoded
...
CREATE TABLE IF NOT EXISTS feria_sectores (
    ...
    categoria_default_id TEXT, -- Texto para categoría (hardcoded)
...
VALUES (
    ...
    1,
    12,
    '2', -- ID de categoría "Dispositivos" (hardcoded)
    true
...
-- categoria_default_id es TEXT para guardar IDs de categorías hardcoded (1, 2, 3, etc.)
